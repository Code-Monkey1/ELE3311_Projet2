...
-- Date        : Mon Mar 30 21:35:18 2020
-- Host        : RAPH running 64-bit major release  (build 9200)
-- Command     : write_vhdl -mode funcsim -nolib -force -file
--               C:/Users/RAPH/Documents/Polytechnique/Systemes_Logiques_Programmables/Labos/Projet2GitHub/ELE3311_Projet2/projet2_raph_oumou/projet2_raph_oumou.sim/sim_1/impl/func/xsim/simon_affichage_del_tb_func_impl.vhd
...
architecture STRUCTURE of cnt is
  ...
  attribute \PinAttr:I1:HOLD_DETOUR\ of \cnt_p[1]_i_1__0\ : label is 193;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \cnt_p[1]_i_1__0\ : label is "soft_lutpair5";
  attribute \PinAttr:I1:HOLD_DETOUR\ of \cnt_p[2]_i_1__0\ : label is 193;
  attribute SOFT_HLUTNM of \cnt_p[2]_i_1__0\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \cnt_p[3]_i_1__0\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \cnt_p[4]_i_1__0\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \cnt_p[6]_i_1__0\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \cnt_p[7]_i_1__0\ : label is "soft_lutpair4";
begin
...
architecture STRUCTURE of delay_cnt is
  ...
  signal end_delay_o0_out : STD_LOGIC;
  ...
  signal \NLW_cnt0_carry__3_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \NLW_cnt0_carry__4_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \NLW_cnt0_carry__5_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \NLW_cnt0_carry__6_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute OPT_MODIFIED of \cnt0_carry__4\ : label is "SWEEP";
  attribute OPT_MODIFIED of \cnt0_carry__5\ : label is "SWEEP";
  attribute OPT_MODIFIED of \cnt0_carry__6\ : label is "SWEEP";
begin
...
\cnt0_carry__3\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2 downto 0) => \NLW_cnt0_carry__3_CO_UNCONNECTED\(2 downto 0),
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
...
\cnt0_carry__4\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2 downto 0) => \NLW_cnt0_carry__4_CO_UNCONNECTED\(2 downto 0),
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
...
\cnt0_carry__5\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2 downto 0) => \NLW_cnt0_carry__5_CO_UNCONNECTED\(2 downto 0),
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
...
\cnt0_carry__6\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 0) => \NLW_cnt0_carry__6_CO_UNCONNECTED\(3 downto 0),
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
...
architecture STRUCTURE of heartbeat is
  ...
  signal \NLW_minusOp_carry__5_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_minusOp_carry__5_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \delay_cnt_p[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of heartbeat_p_i_1 : label is "soft_lutpair2";
  attribute OPT_MODIFIED : string;
...
\minusOp_carry__5\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 0) => \NLW_minusOp_carry__5_CO_UNCONNECTED\(3 downto 0),
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => delay_cnt_p(25),
...
\FSM_sequential_etat_present[0]_i_1__0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"095F090A"
    )
        port map (
...
\FSM_sequential_etat_present[1]_i_1__0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"2C752C20"
    )
        port map (
...
architecture STRUCTURE of msa_display is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_etat_p[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \FSM_sequential_etat_p[1]_i_1\ : label is "soft_lutpair6";
  attribute FSM_ENCODED_STATES : string;
  ...
  attribute SOFT_HLUTNM of \md_seq_p[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of start_delay_p_i_1 : label is "soft_lutpair7";
begin
...
architecture STRUCTURE of msa_simon is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_onehot_etat_present[12]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \FSM_onehot_etat_present[14]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \FSM_onehot_etat_present[15]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \FSM_onehot_etat_present[17]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \FSM_onehot_etat_present[2]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \FSM_onehot_etat_present[3]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \FSM_onehot_etat_present[4]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \FSM_onehot_etat_present[6]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \FSM_onehot_etat_present[7]_i_1\ : label is "soft_lutpair13";
  attribute FSM_ENCODED_STATES : string;
  ...
  attribute SOFT_HLUTNM of item_cnt_inc_p_i_1 : label is "soft_lutpair14";
  attribute \PinAttr:I4:HOLD_DETOUR\ : integer;
  attribute \PinAttr:I4:HOLD_DETOUR\ of item_cnt_rst_p_i_1 : label is 180;
  attribute SOFT_HLUTNM of item_cnt_rst_p_i_1 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of load_prbs_p_i_1 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of ms_digit_valid_p_i_1 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of ms_gameover_p_i_1 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of ms_player_p_i_1 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of next_prbs_p_i_1 : label is "soft_lutpair10";
begin
  AR(0) <= \^ar\(0);
  D(0) <= \^d\(0);
...
entity simon_affichage_del is
  ...
  attribute ECO_CHECKSUM of simon_affichage_del : entity is "1a58e229";
